...
export const asyncRouterMap = [
  ...
  },
  {
    ...
    icon: 'zujian',
    children: [
      { path: 'index', component: componentsIndex, name: '介绍 ', meta: { role: ['editor'] },},
      { path: 'tinymce', component: Tinymce, name: '富文本编辑器' , meta: { role: ['editor'] },},
      { path: 'markdown', component: Markdown, name: 'Markdown' },
      { path: 'jsoneditor', component: JsonEditor, name: 'JSON编辑器', meta: { role: ['editor'] }, },
      { path: 'dndlist', component: DndList, name: '列表拖拽' },
      { path: 'splitpane', component: SplitPane, name: 'SplitPane' },
      { path: 'avatarupload', component: AvatarUpload, name: '头像上传' , meta: { role: ['editor'] },},
